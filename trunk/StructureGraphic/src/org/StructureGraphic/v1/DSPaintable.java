...
public interface DSPaintable {
     ...
     * GRAPHICS OBJECT, IT MUST RESTORE THEM BEFORE RETURNING!!!
     * THE SAME GOES FOR CLIPPING, COLORS AND EVERYTHING ELSE!!!
     *
    ...
    /**
     * Return the width that this node wants for drawing itself. This call
    ...
    /**
     * Return the height that this node wants for drawing itself. This call
     * must return the same value each time!
     *
