...
public class DSutils {
    ...
    public static BufferedImage fromDS (Object val, int rectWidth, int rectHeight) {
        ...
        BufferedImage im = new BufferedImage(paintMe.DSgetWidth()+1, paintMe.DSgetHeight()+1, BufferedImage.TYPE_INT_ARGB);
    ...
    public static void show (final Object val, final int rectWidth, final int rectHeight) {
        new DSImageView(DSutils.fromDS(val, rectWidth, rectHeight)).setVisible(true);
    }
